package com.janosgyerik.stackoverflow.rdsarna;
...
class Sudoku {
	 ...
	 * solution */
	private final List<List<Spot>> solutions;
	...
	private List<Set<Integer>> valInRows, valInCols, valInParts;
	...
	public Sudoku(int[][] ints) {
		...
		for (int i = 0; i < SIZE; i++) {
			valInRows.add(new HashSet<>());
			valInCols.add(new HashSet<>());
			valInParts.add(new HashSet<>());
		}
